...
import { TestTools } from "./dlg/GenkitTools";
import { TestGenkitStructuredOutput } from "./dlg/GenkitStructuredOutput";

const api = new TotoAPIController("toto-ms-ex2", new ControllerConfig(), { basePath: '/ex2' });

api.path('GET', '/genkit/tools', new TestTools(), { contentType: 'application/json', noAuth: true, ignoreBasePath: false})
api.path('GET', '/genkit/structure', new TestGenkitStructuredOutput(), { contentType: 'application/json', noAuth: true, ignoreBasePath: false})
